...
#%%
#Importando o algoritimo de SVM
...
#Retorna a acurácia em procentagem do nosso modelo
...
# %%
#Provavelmente, criando 2 features novas no íris, o svm com 2 features teria mais sucesso. 
# Mas por enquanto usei somente sepal length e petal width (os mais relevantes das 4 features já existentes)
